...
import AccordionSection from "../componenst/AccordionSection";
...
export default function PaymentPage() {
    ...
    const fetchCosmeticDetails = async (cartItems: CartItem[]) => {
        try {
            ...
            // Map each cart item to include bath 'id' and 'quantity'
            ...
            setError("Failed tp fetch cosmetic details");
            setLoading(false);
        }
    };


    // load cart and booking data, and fecth services
    useEffect(() => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Append each ID and quantity to the form data with correct structure
